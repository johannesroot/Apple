        ...
        <div className="container">
          ...
          <div className="footer-links-wrapper row">
            <div className="links-wrapper-1 col-sm-12 col-md">
              <h3 className="dropDown">Shop and Learn</h3>
              <ul>
                <li><a href="#">Mac</a></li>
                <li><a href="#">iPad</a></li>
            ...
            <div className="links-wrapper-2 col-sm-12 col-md">
              <h3 className="dropDown">Services</h3>
              <ul>
              ...
              <h3 className="dropDown">Account</h3>
              <ul>
            ...
            <div className="links-wrapper-3 col-sm-12 col-md">
              <h3 className="dropDown">Apple Store</h3>
              <ul>
            ...
            <div className="links-wrapper-4 col-sm-12 col-md">
              <h3 className="dropDown">For Business</h3>
              <ul>
                <li><a href="#">Apple and Business</a></li>
                <li><a href="#">Shop for Business</a></li>
              </ul>
              <h3 className="dropDown">For Education</h3>
              <ul>
                <li><a href="#">Apple and Education</a></li>
                <li><a href="#">Shop for College</a></li>
              </ul>
              <h3 className="dropDown">For Healthcare</h3>
              <ul>
                <li><a href="#">Manage Your Apple ID</a></li>
                <li><a href="#">Apple Store Account</a></li>
                <li><a href="#">iCloud.com</a></li>
              </ul>
              <h3 className="dropDown">For Government</h3>
              <ul>
                <li><a href="#">Apple and Education</a></li>
                <li><a href="#">Shop for College</a></li>
              </ul>
            ...
            <div className="links-wrapper-5 col-sm-12 col-md">
              <h3 className="dropDown">Apple Values</h3>
              <ul>
                <li><a href="#">Find a Store</a></li>
                <li><a href="#">Genius Bar</a></li>
                <li><a href="#">Today at Apple</a></li>
              ...
              <h3 className="dropDown">About Apple</h3>
              <ul>
                <li><a href="#">Find a Store</a></li>
                <li><a href="#">Genius Bar</a></li>
                <li><a href="#">Today at Apple</a></li>
